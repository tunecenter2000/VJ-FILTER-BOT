...
API_ID = int(environ.get('API_ID', '27582633'))
API_HASH = environ.get('API_HASH', '95a3bb73e61ab339dd63538ec8b20e99')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002183057841'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5475114524').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '--1002232293857').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '1002219382512') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://8pw1wd:gyUV2Iw0qAABblkv@cluster0.y6cwbak.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
